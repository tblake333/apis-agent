...
class TestChangesProcessor:
    ...
    def test_initialization(self, test_connection_info, mock_queue):
    ...
    def test_begin_read_with_changes(self, mock_fdb_connect, test_connection_info, mock_queue):
    ...
    @patch('handlers.changes_processor.fdb.connect')
    def test_begin_read_with_exception(self, mock_fdb_connect, test_connection_info, mock_queue):
    ...
    def test_process_change(self, mock_handler_class, test_connection_info, mock_queue):
        ...
        mock_handler_class.assert_called_once_with(mock_conn, 'test_table', 'id')
