# This implementation maintains a changes log and journals all changes to this changes log table
# Downside of this approach is the journal has to be maintained as a buffer as it can grow too large and querying
# becomes very expensive. This can add unnecessary complexity.
# The buffer logic is not complete below, but it would add more complexity
import fdb
